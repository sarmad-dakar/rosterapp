...
const MOCK_ROSTERS_GROUPS: RosterGroup[] = [
  { code: 'MW2 N/A', description: 'MALE WARD 2 N/A' },
  { code: 'FW7 N/A', description: 'FEMALE WARD 7 N/A' },
  { code: 'COMM', description: 'Community' },
  { code: 'KHC', description: 'Kirkop Health Centre' },
  { code: 'VAT COOKS', description: 'Vat Cooks' },
  { code: 'SBW N/A', description: 'Santa Bernardetta Nursing Aides' },
  { code: 'H/ASST', description: 'HEALTH ASSISTANT' },
  { code: 'COMM ADM', description: 'Community Administration' },
  { code: 'REL 3', description: 'Relievers 3' },
  { code: 'PROC', description: 'Procurements' },
];
        ...
        <View style={styles.header}>
          <View style={styles.headerContent}>
            <View style={styles.iconContainer}>
              <Icon name="group-work" size={24} color="#8b5cf6" />
            </View>
